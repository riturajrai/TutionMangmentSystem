...
const ANIMATED_MODULE_TEXTS = [
  "Manage everything from one modern dashboard",
  "Save hours of daily admin work",
  "Boost revenue with smart analytics",
  "Parents & students love the mobile app",
  "100% secure & 99.98% uptime",
  "Perfect for small to large coaching centers",
  "Fast onboarding — ready in just 48 hours",
];
          ...
          <div className="mt-6 overflow-hidden">
            <div className="relative h-10 sm:h-12">
              ...
              >
                ...
                {[...ANIMATED_MODULE_TEXTS, ...ANIMATED_MODULE_TEXTS].map((text, i) => (
